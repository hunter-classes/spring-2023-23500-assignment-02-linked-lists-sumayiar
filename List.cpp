...
bool List::contains(std::string item){ //returns true if item is in the list and false otherwise.
  Node *walker = head;
  while (walker != nullptr){
...
void List::remove(int loc){ //will remove an item at the specified locaton (int loc)
  Node *walker, *trailer;
  walker = this->head;
  trailer = nullptr; 
